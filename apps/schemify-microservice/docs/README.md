...
Esta guía muestra, de principio a fin, cómo **compilar los `.proto`, arrancar el microservicio `schemify-microservice`, ejecutar las pruebas E2E y realizar pruebas manuales en Kreya**.
...
// package.json
"scripts": {
  "start:schemify": "NODE_ENV=development nest start --watch schemify-microservice"
}
```
